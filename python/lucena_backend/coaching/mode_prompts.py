...
class VerdictPrompt:
    ...
    _RIGHT = (
        ...
        "threat: White threatens mate: Ra4#', or 'mate in 5 — it starts with Bxf6+'), state what it "
        "ACHIEVES as the facts give it — a checkmate (in how many moves if a number is stated), or the "
        "material won — not merely the move's name; when the facts say mate, write the WORD "
        "('checkmate'/'mate'), never lean on the '#' alone. Never state a threat, or any detail of it, "
